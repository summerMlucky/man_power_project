...
<script>
import { getEmployeesJobInfo as getJobDetail } from '@/api/employees'
import { getEmployeeInfoById as getPersonalDetail, saveUserDetailById as getUserDetailById } from '@/api/user'
export default {
  data() {
    return {
      formData: {},
